        ...
        if(!defined('FLUENTFORM_DISABLE_EDITOR_FILED_HOOOK')) {
            ...
            if ($formFields) {
                ...
                foreach ( $formFields['fields'] as $index => $formField ) {
                    $formFields['fields'][$index] = apply_filters('fluentform_editor_init_element_' . $formField['element'], $formField, $form);
                    ...
                    if ($formField['element'] == 'container') {
                        ...
                        foreach ($columns as $columnIndex => $column) {
                            foreach ($column['fields'] as $fieldIndex => $columnField) {
                                $columns[$columnIndex]['fields'][$fieldIndex] = apply_filters('fluentform_editor_init_element_' . $columnField['element'], $columnField, $form);
