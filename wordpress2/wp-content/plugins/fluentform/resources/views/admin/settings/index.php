            ...
            <div class="ff_settings_sidebar">
                <ul class="ff_settings_list">
                    ...
                    <?php foreach ($components as $component): ?>
                        <li class="<?php echo Helper::getHtmlElementClass($component['hash'], $currentComponent); ?>">
                            <a data-settings_key="<?php echo ArrayHelper::get($component, 'settings_key'); ?>" data-component="<?php echo ArrayHelper::get($component, 'component', ''); ?>" data-hash="<?php echo ArrayHelper::get($component, 'hash', ''); ?>"
