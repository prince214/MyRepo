...
<style type="text/css">
  ...
  .verticalLine {
  border-left: thick solid #2196f3;
...
<style type="text/css">
  ...
  height:3.5vw; max-height:80px;
  width:auto;
  stroke:#fff;
  stroke-width:15;
  fill:none;
}
#tw {stroke-dasharray:  300 , 0, 3000;}
#st {stroke-dasharray:    0 , 0, 2300;}
#fa {stroke-dasharray:    0 , 0, 2900;}
#co {stroke-dasharray:  300 , 0, 3000;}
#px {stroke-dasharray: 3200 , 0, 3000;}

svg:hover #tw { animation: tw .7s; }
svg:hover #st { animation: st .7s; }
svg:hover #fa { animation: fa .7s; }
svg:hover #co { animation: co .7s; }
svg:hover #px { animation: px .7s; }

@keyframes tw { 10% {stroke-dasharray:  300, 500, 3000} 100% { stroke-dasharray:3300, 500, 3000;} }
@keyframes st { 10% {stroke-dasharray:    0, 500, 2300} 100% { stroke-dasharray:2300, 500, 2300;} }
@keyframes fa { 10% {stroke-dasharray:    0, 500, 2900} 100% { stroke-dasharray:2900, 500, 2900;} }
@keyframes co { 10% {stroke-dasharray:  300, 500, 3000} 100% { stroke-dasharray:2300, 500, 3000;} }
@keyframes px { 10% {stroke-dasharray: 3200, 500, 3000} 100% { stroke-dasharray:6200, 500, 3000;} }
...
<div class="container pt-5 pb-5">
	...
	<div class="col-sm-12 shadow p-5 back ">

	<?php
	if( have_rows('member-name') ):
	// loop through the rows of data
	while ( have_rows('member-name') ) : the_row();	?>
	<div class="col-sm-3 d-inline-block">
	<img class="img-fluid rounded-circle "src="<?php the_sub_field('member-photo'); ?>">
	</div>

	  
	<div class="col-sm-4 d-inline-block verticalLine ">
	<div class="in col-sm-12">
	<span class="title"><b>Name:</b> </span><span class="text"><?php the_title(); ?></span><br>
	<span class="title"><b>Position:</b> </span><span class="text"><?php the_sub_field('position'); ?></span><br>
	<span class="title"><b>Experience: </b></span><span class="text">2 Years</span><br>
	<span class="title"><b>Age:</b> </span><span class="text">23 Years</span>
	</div>
	</div>

	<div class="col-sm-4  d-inline-block ">

	<a target="_blank" href="https://twitter.com/web_tiki">
	...
	<a target="_blank" href="http://stackoverflow.com/users/1811992/web-tiki">
	<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1000 1000" width="100" height="100">
	<g id="st">
	...
	<a target="_blank" href="https://www.facebook.com/webtiki/">
	<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1000 1000" width="100" height="100">
