...
function my_custom_menu_item($items)
{
    if(is_user_logged_in())
    {
        ...
        $items .= '<li class="nav-item dropdown"><a id="navbarDropdown" data-toggle="dropdown" class="nav-link dropdown-toggle js-scroll-trigger" href=""><i class="far fa-user-circle"></i> Welcome '.$name.'</a>
        <div class="dropdown-menu" style="background-color: transparent; border: none;">
          <a id="hover_back" class="dropdown-item nav-link " style="opacity: 0.6;" href="#">Your Profile</a>
          <a id="hover_back" class="dropdown-item nav-link " style="opacity: 0.6;" href="http://localhost/Prince/wordpress2/wp-login.php?action=logout">Logout</a>
        </div>
        </li>';
    }
    return $items;
