...
if (!empty($_POST["token"])) {
    ...
    echo "fasdfasdfasfdsafdasfdafasfd";
...
<main id="site-content" role="main" class="asd">
    ...
    <div id="error-message"></div>
            ...
            <form id="frmStripePayment" action="http://localhost/Prince/wordpress4/paypal"
                method="post">
                <div class="field-row">
                ...
                <div>
                    ...
                    <div id="loader">
                        <img alt="loader" src="<?php echo get_template_directory_uri(); ?>/LoaderIcon.gif">
                    </div>
                </div>
    ...
    <div class="test-data">
        ...
        <table class="tutorial-table" cellspacing="0" cellpadding="0" assetswidth="100%">
            <tr>
                <th>CARD NUMBER</th>
                <th>BRAND</th>
            </tr>
...
<?php  include'assets/js/allJS.php' ?>
